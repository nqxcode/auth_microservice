...
//go:generate minimock -i github.com/nqxcode/auth_microservice/internal/service.AuditLogService -o ./mocks\audit_log_service_minimock.go -n AuditLogServiceMock
